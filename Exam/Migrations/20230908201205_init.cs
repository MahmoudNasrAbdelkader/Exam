...
namespace Exam.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "QuestionChooses",
                columns: table => new
                {
                    QuestionChooseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionChooses", x => x.QuestionChooseId);
                    table.ForeignKey(
                        name: "FK_QuestionChooses_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    QuestionChooseId = table.Column<int>(type: "int", nullable: false),
                    UserAnswered = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionChooses_QuestionId",
                table: "QuestionChooses",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_QuestionChooseId",
                table: "UserAnswers",
